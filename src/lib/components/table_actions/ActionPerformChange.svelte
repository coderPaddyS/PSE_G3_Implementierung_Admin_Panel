...
<script lang=ts>
     ...
     * This action collects the data of the current row and performs the action matching the data.
     * 
...
<button on:click={() => crawlOnView(createCrawler())}>Akzeptieren</button>
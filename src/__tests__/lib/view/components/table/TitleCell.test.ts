...
import { TitleCell, TableData, TableRow } from "$lib/model/recursive_table/TableComponents";
import TitleCellComp from "$lib/view/components/table/TitleCellComp.svelte";
import MockContext from "./__mocks__/MockContext.svelte";
import { crawlerKey, Sorter } from "$lib/model/recursive_table/Types";
...
describe("Test TitleCellComp.svelte", () => {
    describe("to render given", () => {
        ...
        test("test cell with sorter correctly", () => {

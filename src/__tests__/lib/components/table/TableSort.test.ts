...
import TableSort from "$lib/components/table/TableSort.svelte";
import MockContext from "./__mocks__/MockContext.svelte";
import { crawlerKey, Sorter } from "$lib/model/table/Types";
import type { TableSortingCrawler } from "$lib/model/table/crawler/SortingCrawler";
import lodash from "lodash";
import { lexicographicSorter } from "$lib/model/TableManager";
